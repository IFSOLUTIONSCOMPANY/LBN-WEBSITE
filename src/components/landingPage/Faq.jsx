...
export default function Faq() {
  return (
    <section className="relative z-20 overflow-hidden px-10 pb-8 pt-20 lg:pb-[50px] lg:pt-[120px] container mx-auto">
      <div className="container mx-auto">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center">
              ...
              <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
                Any Questions<FontAwesomeIcon icon={faQuestion} className="text-accent" /> 
                <div className='mt-4'>Look Here</div>
              </h2>
        ...
        <div className="-mx-4 flex flex-wrap" >
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 flex lg:mb-[70px]" data-aos="fade-up">
              <div className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-accent text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 34 34"
